...
export const DEFAULT_SHOP_SETTINGS: Record<string, string> = {
  ...
  authorizedRepresentative: "Antonio Bellanova",
  contentResponsible: "Antonio Bellanova",
  tradeRegisterCourt: "",
  tradeRegisterNumber: "",
  economicId: "",
  ...
  paymentMethodsJson: JSON.stringify([
    ...
    },
    {
      ...
      description: "Sie zahlen den Rechnungsbetrag per Banküberweisung. Der Versand erfolgt nach vollständigem Zahlungseingang.",
      sortOrder: 2,
    },
  ]),
