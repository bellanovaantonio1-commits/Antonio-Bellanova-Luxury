...
const svgClass = "block h-full w-full max-h-6 max-w-full";

export default function PaymentMethodIcon({ id, className = "h-6 w-[4.75rem]" }: PaymentMethodIconProps) {
  const wrap = `${className} inline-flex items-center justify-center shrink-0`;

  switch (id) {
    case "stripe":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Stripe">
            <path
              fill="#635BFF"
    ...
    case "visa":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Visa">
            <path
              fill="#FFFFFF"
            ...
            />
            <path fill="#F7B600" d="M10.5 11.5 7.8 18.8 7.4 16.8c-.6-2.2-2.5-4-4.7-4.9l3.2 8.6H0L5.6 11.5h4.6z" />
          </svg>
        </span>
      );
    ...
    case "mastercard":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Mastercard">
            <circle cx="19" cy="16" r="9" fill="#EB001B" />
            <circle cx="29" cy="16" r="9" fill="#F79E1B" />
            <path fill="#FF5F00" d="M24 9.2a9 9 0 0 0-3.4 7.8 9 9 0 0 0 3.4 7.8 9 9 0 0 0 3.4-7.8 9 9 0 0 0-3.4-7.8z" />
          </svg>
        </span>
      );
    ...
    case "amex":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="American Express">
            <rect x="2" y="8" width="44" height="16" rx="2" fill="#2E77BC" />
            <path
              fill="#FFFFFF"
              d="M6.5 11.5h3.2l.8 2 .8-2h3.2v9h-2.3v-5.2l-1.1 2.7h-1.4l-1.1-2.7V20.5H6.5v-9zm10.2 0h5.6c1.8 0 3.1 1.2 3.1 3 0 1.2-.6 2.1-1.6 2.5l2 3.5h-2.6l-1.7-3h-1.4v3h-2.4v-9h2.4zm2.4 1.8v1.8h2.8c.6 0 1-.3 1-.9s-.4-.9-1-.9h-2.8zm8.1-1.8h2.4l3.2 5.2V11.5h2.4v9h-2.4l-3.2-5.2v5.2h-2.4v-9zm10.8 0h7.5v1.8h-5.1v1.5h4.6v1.8h-4.6v1.1h5.2v1.8h-7.6v-9z"
            />
          </svg>
        </span>
      );
    ...
    case "apple_pay":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Apple Pay">
            <path
              fill="#FFFFFF"
            ...
            <path
              fill="#FFFFFF"
              d="M21 11.5V20h-2.6v-2.8h-.1c-.6 1-1.7 3.1-4.4 3.1-2.8 0-4.9-2.2-4.9-5.8 0-3.5 2.1-5.8 4.8-5.8 2.7 0 3.8 2.1 4.4 3.1h.1v-2.8H21v-.1zm-2.6 7.3c0-2.2-1.5-3.7-3.7-3.7-2.2 0-3.8 1.5-3.8 3.7 0 2.2 1.6 3.7 3.8 3.7 2.2 0 3.7-1.5 3.7-3.7zm7.2-7.3h4.4c2.5 0 4.2 1.4 4.2 3.7 0 2.1-1.3 3.4-3.2 3.6l3.8 5.4h-3l-3.4-4.9h-2.6v4.9h-2.6V11.5zm2.6 2.3v3h1.7c1.2 0 2-.6 2-1.5 0-.9-.8-1.5-2-1.5h-1.7z"
            />
          </svg>
        </span>
      );
    ...
    case "google_pay":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Google Pay">
            <path fill="#4285F4" d="M18.5 16c0-1.3.4-2.5 1.1-3.5l-2.8-2.2C15.7 12.1 14.8 14 14.8 16s.9 3.9 2 5.7l2.8-2.2c-.7-1-1.1-2.2-1.1-3.5z" />
            ...
            <path fill="#EA4335" d="M22.8 12.7c1.6 0 3 .6 4.1 1.5l2.8-2.8C26.9 9.8 25 9 22.8 9c-2.5 0-4.6 1.1-6 2.9l2.8 2.2c.8-1.2 2-2 3.2-2.4z" />
            <path fill="#FFFFFF" d="M27 20.5V11.5h2.4v9H27zm-4.5 0L20.5 11.5h2.6l3 7.6 3-7.6h2.6L25.5 20.5H21z" />
          </svg>
        </span>
      );
    ...
    case "paypal":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="PayPal">
            <path
              fill="#009CDE"
    ...
    case "bank_transfer":
      return (
        <span className={wrap} aria-hidden>
          <svg viewBox="0 0 48 32" className={svgClass} role="img" aria-label="Banküberweisung" fill="none">
            <path
              stroke="#C5A059"
              strokeWidth="1.1"
              strokeLinecap="round"
